...
var _verbose_summary_formatter = require('./verbose_summary_formatter');

var _verbose_summary_formatter2 = _interopRequireDefault(_verbose_summary_formatter);
  ...
  (0, _createClass3.default)(FormatterBuilder, null, [{
    ...
    value: function getConstructorByType(type, options) {
      switch (type) {
        ...
        case 'verbose-summary':
          return _verbose_summary_formatter2.default;
        default:
